...
public class PropertyServiceTest {
    ...
    void testFindAllPropertyByAvailableDate(){
        ...
        List<Property> testPropList = propertyService.getAllPropertiesByDateAvailable(LocalDate.of(2021,5,7));

        assertThat(testPropList).isInstanceOf(List.class);
        assertThat(testPropList).isNotEmpty();
        assertThat(testPropList.get(0).getAvailableDate()).isEqualTo("2021-05-07");
